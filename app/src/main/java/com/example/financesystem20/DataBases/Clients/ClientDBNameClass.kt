...
object ClientDBNameClass {
    ...
    const val CREAT_TABLE="CREATE TABLE IF NOT EXISTS $TABLE_NAME("+
            "${BaseColumns._ID} INTEGER PRIMARY KEY,$COLUMN_NAME_LOGIN TEXT,$COLUMN_NAME_NAME TEXT,$COLUMN_NAME_SURNAME TEXT,"+
            "$COLUMN_NAME_PHONENUMBER TEXT,$COLUMN_NAME_EMAIL TEXT)"
